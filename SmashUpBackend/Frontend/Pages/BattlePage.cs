...
namespace SmashUp.Frontend.Pages
{
    ...
    /// </summary>
    internal class BattlePage(List<BaseSlot> baseSlots, Player activePlayer, List<PlayableCard> playableCardOptions, Guid endTurnButtonId, Targeter targeter, string displayText = "") : ValuePage<Guid>
    {
