...
namespace SmashUp.Frontend.Pages
{
    ...
    /// </summary>
    internal class BattlePage(List<BaseSlot> baseSlots, Player activePlayer, Guid endTurnButtonId, Targeter targeter) : ValuePage<Guid>
    {
