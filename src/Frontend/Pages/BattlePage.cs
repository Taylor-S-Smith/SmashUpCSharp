...
public record Button(Guid Id, string text);
...
namespace SmashUp.Frontend.Pages
{
    ...
    /// </summary>
    internal class BattlePage(List<BaseSlot> baseSlots, Player activePlayer, List<PlayableCard> playableCardOptions, List<Button> buttons, Targeter targeter, string displayText = "") : ValuePage<Guid>
    {
        ...
        private readonly List<PlayableCard> _playableCardOptions = playableCardOptions;
        int _optionDisplayIndex = 0;
        List<Button> _buttons = buttons;
        ...
        protected override StringBuilder GenerateRender(int consoleWidth, int consoleHeight)
        {
            ...
            var buttonField = GenerateButtonField(baseField.Max(line => line.Length));
            ...
            int renderWidth = new[] {
                ...
                buttonField.Max(line => line.Length)
            }.Max();
        ...
        private string[] GenerateInputField(int fieldLength)
        {
            ...
            // Hand/Option Display
            if (_playableCardOptions.Count > 0)
            {
                string[][] allGraphics = _playableCardOptions.Select(GeneratePlayableCardGraphic).ToArray();
                ...
                else if (_optionDisplayIndex > 0 && _targeter.GetTargetId() == _playableCardOptions[_optionDisplayIndex - 1].Id)
                {
                    _optionDisplayIndex--;
                }
