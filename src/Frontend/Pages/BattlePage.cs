...
namespace SmashUp.Frontend.Pages
{
    ...
    /// </summary>
    internal class BattlePage(List<BaseSlot> baseSlots, Player activePlayer, List<PlayableCard> playableCardsToDisplay, List<Button> buttons, Targeter targeter, string displayText = "") : ValuePage<Guid>
    {
