...
public static class RenderUtil
{
    ...
    public static StringBuilder GenerateTextSelect(int consoleWidth, int consoleHeight, string[] header, string[] options, int selectedOption, int headerPadding, int optionPadding)
    {
